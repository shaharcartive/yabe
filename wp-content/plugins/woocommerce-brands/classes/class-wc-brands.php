	...
	public static function init_taxonomy() {
		...
		register_taxonomy( 'product_brand',
	        ...
	        apply_filters( 'register_taxonomy_product_brand', array(
	            ...
	            'labels' => array(
	                    'name' 				=> __( 'Marcas', 'wc_brands' ),
	                    'singular_name' 	=> __( 'Marca', 'wc_brands' ),
	                    'search_items' 		=> __( 'Buscar Marcas', 'wc_brands' ),
	                    'all_items' 		=> __( 'Todas las Marcas', 'wc_brands' ),
	                    'parent_item' 		=> __( 'Parent Brand', 'wc_brands' ),
	                    'parent_item_colon' => __( 'Parent Brand:', 'wc_brands' ),
	                    'edit_item' 		=> __( 'Editar Marca', 'wc_brands' ),
	                    'update_item' 		=> __( 'Actualizar Marca', 'wc_brands' ),
	                    'add_new_item' 		=> __( 'Añadir nueva Marca', 'wc_brands' ),
	                    'new_item_name' 	=> __( 'Nuevo nombre de Marca', 'wc_brands' )
	            	),
	            'show_ui' 				=> true,
	            ...
	            'rewrite' 				=> array( 'slug' => $category_base . __( 'marca', 'wc_brands' ), 'with_front' => false, 'hierarchical' => true )
	        ) )
	    );
	}
