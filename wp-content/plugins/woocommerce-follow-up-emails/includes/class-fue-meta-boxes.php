...
class FUE_Meta_Boxes {
    ...
    public function form_title_placeholder( $title, $post ) {
        if ( $post->post_type == 'follow_up_email' ) {
            $title = __('Email name', 'follow_up_emails');
        }
    ...
    public function add_dummy_content( $post ) {
        ...
        <div id="email_content_dummy">
            <?php _e("<p>Create your email body by typing it here. You can really do anything with this content. Include HTML, or keep the email plain text. That is up to you.</p><p>If you wish to include variables from the list to the right, you can certainly do that. For example, if you want the Customer's name in the email, simply add {customer_name} where you want in your content, and when the email is sent, that variable will be replaced with the Customer's name.</p>", 'follow_up_email'); ?>
        </div>
        <?php
    }
    ...
    public function add_meta_boxes() {
        add_meta_box( 'fue-email-details', __( 'Email Details', 'follow-up-emails' ), 'FUE_Meta_Boxes::email_details_view', 'follow_up_email', 'normal', 'high' );

        add_meta_box( 'fue-email-type', __( 'Email Type', 'follow-up-emails' ), 'FUE_Meta_Boxes::email_type_view', 'follow_up_email', 'side', 'high' );
        ...
        add_meta_box( 'fue-email-actions', __( 'Email Actions', 'follow-up-emails' ), 'FUE_Meta_Boxes::email_actions', 'follow_up_email', 'side', 'high' );
