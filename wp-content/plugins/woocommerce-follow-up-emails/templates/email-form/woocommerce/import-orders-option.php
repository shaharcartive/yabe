<div class="options_group">
    <p class="form-field">
        ...
        <input type="checkbox" name="meta[import_orders]" id="import_orders" value="yes" <?php if (isset($values['meta']['import_orders']) && $values['meta']['import_orders'] == 'yes') echo 'checked'; ?> />
