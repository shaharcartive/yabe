<div class="options_group">
    ...
    <p class="form-field">
        <label><?php _e('Sending Schedule', 'follow_up_emails'); ?></label>

        <span class="hide-if-date interval_span hideable">
            <input type="number" min="1" step="1" name="interval" id="interval" value="<?php echo esc_attr( $email->interval ); ?>" size="2" style="vertical-align: top; width: 50px;" />
        </span>
    ...
    <div id="trigger_conditions" class="hide-if-date non-signup">
        ...
        if ( $email_conditions ):
            foreach ( $email_conditions as $idx => $email_condition ):
                ...
                <fieldset id="condition_<?php echo $idx; ?>">
                    ...
                    <a href="#" class="button btn-remove-condition">&cross;</a>
        ...
        <p>
            <a class="button btn-add-condition"><?php _e('&plus; Add a requirement', 'follow_up_emails'); ?></a>
        </p>
    </div>
