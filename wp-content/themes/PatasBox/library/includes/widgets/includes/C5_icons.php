...
class C5AB_ICONS {
	...
	function get_icons_spans($value) {
		$spans = '';
		...
		foreach ( $this->icons() as $icon) {
			...
			$spans .= '<li class="c5_span_icon '.$selected.'" data-class="fa fa-'.$icon.'"><span class="fa fa-'.$icon.'"></span></li>';
		}
		return $spans;
	}
	
	function get_icons_as_images() {
		$array = array();
