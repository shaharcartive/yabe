...
if ( $customer_orders ) : ?>
	<h2 class="text-center title-line"><span><?php echo apply_filters( 'woocommerce_my_account_my_orders_title', __( 'Recent Orders', 'woocommerce' ) ); ?></span></h2>
	...
	<table class="shop_table my_account_orders">
		...
		<thead>
			<tr>
				...
				<th class="order-product"><span class="nobr">Producto</span></th>
				...
				?><tr class="order">
					...
					<?php
						foreach($order->get_items() as $item) {
    						...
    						$product_meta = $item['pa_duracion'];
						}
					?>
					
					<td class="order-product">
						<strong><?php echo $product_name?></strong>
						<p><?php echo $product_meta?></p>
					</td>
